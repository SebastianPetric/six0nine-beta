...
public class FaceToCam1 : MonoBehaviour
{
    ...
    KalmanFilterSimple1D1 kalman_X;
    KalmanFilterSimple1D1 kalman_Y;
    KalmanFilterSimple1D1 kalman_mod;

    void Start()
    {
        updateFrame = 0;
        kalman_X = new KalmanFilterSimple1D1(f: 1, h: 1, q: qq, r: rr);
        kalman_Y = new KalmanFilterSimple1D1(f: 1, h: 1, q: qq, r: rr);
        kalman_mod = new KalmanFilterSimple1D1(f: 1, h: 1, q: qq, r: rr);
    ...
    void LateUpdate()
    {
        ...
        var bodySourceManager = bodyManager.GetComponent<BodySourceManager1>();
